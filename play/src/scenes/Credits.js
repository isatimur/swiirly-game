...
const CREDITS = [
  ...
  { kind: "name",    text: "{your_team_member_1}" },
  { kind: "name",    text: "{your_team_member_2}" },
  { kind: "name",    text: "{your_team_member_3}" },
  { kind: "note",    text: "(edit this list in play/src/scenes/Credits.js)" },
  { kind: "blank" },
